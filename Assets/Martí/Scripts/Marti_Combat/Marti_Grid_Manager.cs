...
public class Marti_Grid_Manager : MonoBehaviour
{
    ...
    static public Marti_Grid_Manager Instance
    {
    ...
    {
        Marti_Tile_Manager currentTile = m_tiles[(int)p_tilePosition.y, (int)p_tilePosition.x].GetComponent<Marti_Tile_Manager>();
    ...
    public bool IsTileEmpty(Vector2 p_tilePosition)
    {
        ...
        {
            return m_tiles[(int)p_tilePosition.y, (int)p_tilePosition.x].GetComponent<Marti_Tile_Manager>().IsTileEmpty;
        }
        return false;
    }
}